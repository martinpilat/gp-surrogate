...
with open('train_data/baseline.pagie-1.v1.79571df537.r0.g.0.pkl', 'rb') as f:
    data = pickle.load(f)
...
for i in range(200):
    print("-"*80, i)
    print("inputs/outputs for aux:", data[0][i].io[0])
    print("inputs/outputs for aux:", data[0][i].io[1])
