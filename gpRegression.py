...
parser.add_argument('--repeats', '-K', type=int, help='How many times to run the algorithm', default=30)
...
parser.add_argument('--gnn_hidden', '-H', type=int, help='GIN/TreeLSTM hidden size', default=64)
parser.add_argument('--dense_hidden', '-J', type=int, help='Linear hidden size', default=64)
...
parser.add_argument('--batch_size', type=int, help='Batch size for GNN / TreeLSTM', default=128)
